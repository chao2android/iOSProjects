...
@interface OthersAttListViewController : BaseADViewController <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, RefreshTableViewDelegate>
{
