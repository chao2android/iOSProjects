...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        mlbMsg.textAlignment = UITextAlignmentCenter;
...
+ (void)ShowAlert:(NSString *)title message:(NSString *)message :(int)delay {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:title message:message delegate:nil cancelButtonTitle:nil otherButtonTitles:nil];
//    [[UserInfoManager Share] performSelector:@selector(HideAlertView:) withObject:alertView afterDelay:delay];
    [alertView show];
    [alertView release];
}
