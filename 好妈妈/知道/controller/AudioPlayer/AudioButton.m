...
NSString *playImage = @"音频1.png";
NSString *stopImage = @"yinpin2.png";
...
{
    if (!loadingView) {
        loadingView = [[UIImageView alloc] initWithFrame:CGRectMake(21, 1, 29, 29)];
        loadingView.image = [UIImage imageNamed:@"audio_loading.png"];
