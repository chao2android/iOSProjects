...
#define _B 0.0
#define _A 1.0
#define PLAY_IMAGE_STR @"音频1.png"
#define PAUSE_IMAGE_STR @"yinpin2.png"
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
		...
		_b = _B;
		_a = _A;
        playImage = [UIImage imageNamed:PLAY_IMAGE_STR];
        pauseImage = [UIImage imageNamed:PAUSE_IMAGE_STR];
