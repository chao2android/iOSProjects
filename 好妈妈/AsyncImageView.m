...
@synthesize AutomaticAdjustmentProportion;
@synthesize indexPa = _indexPa;

- (id)initWithFrame:(CGRect)frame {
	if (self == [super initWithFrame:frame]) 
	{
        AutomaticAdjustmentProportion = NO;
...
- (void) setUrlString:(NSString *) theUrl
{
	...
	[urlString release];
	urlString = nil;
	[self imageDidLoaded: nil animate: YES];
	if (nil == theUrl) 
	{
...
- (void)setImage:(UIImage*) _image animate: (BOOL) animate
{
    ...
    if (AutomaticAdjustmentProportion == YES)
    {
