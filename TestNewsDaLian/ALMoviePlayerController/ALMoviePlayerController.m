...
static const CGFloat movieBackgroundPadding = 2.f; //if we don't pad the movie's background view, the edges will appear jagged when rotating
...
- (void)setFullscreen:(BOOL)fullscreen animated:(BOOL)animated {
    ...
    if (fullscreen) {
        ...
        [UIView animateWithDuration:animated ? fullscreenAnimationDuration : 0.0 delay:0.0 options:UIViewAnimationOptionCurveLinear animations:^{
            ...
            UIInterfaceOrientation currentOrientation =  UIInterfaceOrientationLandscapeRight;
