...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        mbLightNav = YES;
        mFontSize = 20;
        self.mTopImage = [UIImage imageNamed:IOS_7?@"tiao7.png":@"tiao6.png"];
        self.mTopColor = [UIColor colorWithRed:0.15 green:0.56 blue:0.9 alpha:1.0];
        //self.mTopColor = [UIColor purpleColor];
...
- (void)viewDidLoad
{
   ...
   // mlbTitle.font = [UIFont fontWithName:@"Helvetica-Bold" size:mFontSize];
    mlbTitle.font = [UIFont systemFontOfSize:20];
    self.mlbTitle.textAlignment = NSTextAlignmentCenter;
...
- (void)goLoading{
    isLoading= [[UIView alloc]initWithFrame:self.view.bounds];
    isLoading.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
    [self.view addSubview:isLoading];
    ...
    [isLoading addSubview:isContinuingImage];

}

- (void)stopLoding{
    [isLoading removeFromSuperview];
    isLoading = nil;
}
