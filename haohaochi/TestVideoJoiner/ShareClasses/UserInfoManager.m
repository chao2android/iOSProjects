...
#pragma mark - 自动保存到手机
- (BOOL)mbAutoSave {
    NSNumber *number = [[NSUserDefaults standardUserDefaults] objectForKey:@"autosave"];
    return [number boolValue];
}

- (void)setMbAutoSave:(BOOL)value {
    [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:value] forKey:@"autosave"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
- (BOOL)mbWifiUpload {
    NSNumber *number = [[NSUserDefaults standardUserDefaults] objectForKey:@"wifiupload"];
    return [number boolValue];
}

- (void)setMbWifiUpload:(BOOL)value {
    [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:value] forKey:@"wifiupload"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
- (BOOL)mbPush {
    NSNumber *number = [[NSUserDefaults standardUserDefaults] objectForKey:@"enablepush"];
    return [number boolValue];
}

- (void)setMbPush:(BOOL)value {
    [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:value] forKey:@"enablepush"];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
#pragma mark - ViewImage

- (UIImage *)GetViewImage:(UIView *)view :(float)zoomscale {
    UIGraphicsBeginImageContextWithOptions(view.bounds.size, NO, zoomscale);
...
- (void)SaveToAlbum:(UIView *)view {
    UIImage *viewImage = [self GetViewImage:view :2.0];
