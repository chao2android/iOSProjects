...
public class DialogUtils {
	 ...
	 * @author likai
	 */
	public static void showAlertDialog(Context mContext, String txtRes, String btnRes, final boolean isOutSideClose,
			final OnSelectCallBack callBack) {
		final Dialog dialog = new Dialog(mContext, R.style.dialog);
		View v = View.inflate(mContext, R.layout.dialog_alert_layout, null);
		dialog.setContentView(v);
		// 描述信息
		TextView txt = (TextView) v.findViewById(R.id.dialogAlertTitle);
		txt.setText(txtRes);
		// 确认按钮
