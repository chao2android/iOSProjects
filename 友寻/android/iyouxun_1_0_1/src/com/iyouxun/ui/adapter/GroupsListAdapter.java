...
public class GroupsListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			vh.groups_top_space = convertView.findViewById(R.id.groups_top_space);
		...
		// 顶部space
		if (position == 0) {
			vh.groups_top_space.setVisibility(View.VISIBLE);
		} else {
			vh.groups_top_space.setVisibility(View.GONE);
		}
