...
public class PaintUtil {
	...
	public static Paint newBorderPaint(Context context) {
		...
		final float lineThicknessPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_LINE_THICKNESS_DP, context
	...
	public static Paint newCornerPaint(Context context) {
		...
		// Set the line thickness for the crop window border.
		final float lineThicknessPx = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_THICKNESS_DP, context
				.getResources().getDisplayMetrics());
