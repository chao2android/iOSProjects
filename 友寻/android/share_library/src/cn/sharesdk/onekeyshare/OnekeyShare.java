/*
 * 官网地站:http://www.mob.com 技术支持QQ: 4006852216 官方微信:ShareSDK
 * （如果发布新版本的话，我们将会第一时间通过微信将版本更新内容推送给您
 * 。如果使用过程中有任何问题，也可以通过微信与我们取得联系，我们将会在24小时内给予回复）
 * 
...
public class OnekeyShare implements PlatformActionListener, Callback {
	...
	private final ArrayList<CustomerLogo> customers;
	private boolean silent;
	private PlatformActionListener callback;
	private ShareContentCustomizeCallback customizeCallback;
	private boolean dialogMode = false;
	private boolean disableSSO;
	private final HashMap<String, String> hiddenPlatforms;
	private View bgView;
