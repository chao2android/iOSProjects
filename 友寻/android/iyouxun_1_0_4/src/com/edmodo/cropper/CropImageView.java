...
public class CropImageView extends FrameLayout {
	...
	public Bitmap getCroppedImage() {
		...
		final float actualCropWidth = cropWindowWidth * scaleFactorWidth <= mBitmap.getWidth() ? cropWindowWidth
				* scaleFactorWidth : mBitmap.getWidth();
		final float actualCropHeight = cropWindowHeight * scaleFactorHeight <= mBitmap.getHeight() ? cropWindowHeight
				* scaleFactorHeight : mBitmap.getHeight();

		if (actualCropHeight > 0 && actualCropWidth > 0) {
			...
			final Bitmap croppedBitmap = Bitmap.createBitmap(mBitmap, (int) actualCropX, (int) actualCropY, 200, 200);
