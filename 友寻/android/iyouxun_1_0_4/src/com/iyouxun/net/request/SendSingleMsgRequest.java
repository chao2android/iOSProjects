...
public class SendSingleMsgRequest extends J_Request {

	public SendSingleMsgRequest(OnDataBack callBack) {
		super(callBack);
	 ...
	 * @throws
	 */
	public J_Request send(String toUid, String avatar, int sex, String province, String city, String nick, int marriage) {
		JSONObject object = new JSONObject();
		try {
			object.put(UtilRequest.FORM_TO_UID, toUid);
