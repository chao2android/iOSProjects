...
public class CircularImage extends ImageView {
	...
	private boolean mBoundedConcer = false;
	private final int mConcerRadius = 26;
	...
	public CircularImage(Context context, AttributeSet attrs, int defStyle) {
		...
		mBoundedConcer = a.getBoolean(R.styleable.CircleImageView_rounded_corner, false);
		a.recycle();
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mBoundedConcer) {
			canvas.drawRoundRect(mDrawableRect, mConcerRadius, mConcerRadius, mBitmapPaint);
		} else {
