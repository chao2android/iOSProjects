...
public class HandleUtil {
	...
	public static float getTargetRadius(Context context) {
		...
		final float targetRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, TARGET_RADIUS_DP, context
	 ...
	 *         otherwise
	 */
	private static boolean isInHorizontalTargetZone(float x, float y, float handleXStart, float handleXEnd, float handleY,
			float targetRadius) {
