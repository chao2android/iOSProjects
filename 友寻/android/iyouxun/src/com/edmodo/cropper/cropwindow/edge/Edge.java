...
public enum Edge {
	...
	/**
	 * Returns whether or not you can re-scale the image based on whether any
	 * edge would be out of bounds. Checks all the edges for a possibility of
	...
	/**
	 * Returns the potential snap offset of snaptoRect, without changing the
	 * coordinate.
	 * 
	 * @param imageRect the bounding rectangle of the image to snap to
	 * @return the amount (in pixels) that this coordinate was changed (i.e. the
	...
	/**
	 * Determines if this Edge is outside the inner margins of the given
	 * bounding rectangle. The margins come inside the actual frame by
	 * SNAPRADIUS amount; therefore, determines if the point is outside the
	 * inner "margin" frame.
	 * 
	 */
