...
public class SelectFriendsAdapter extends BaseAdapter {
	...
	public SelectFriendsAdapter(Context mContext, ArrayList<ManageFriendsBean> arrayList) {
		datas = arrayList;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (datas.get(position).isHasRegistered()) {
			...
			if (datas.get(position).getRelation() == 1) {
				holder.hasRegistered.setImageResource(R.drawable.icon_dimen_one);
			} else {
