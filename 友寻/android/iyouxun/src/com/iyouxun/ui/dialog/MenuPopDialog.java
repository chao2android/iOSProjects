...
public class MenuPopDialog extends PopupWindow {
	...
	public MenuPopDialog setDefault(int index) {
		...
		if (defaultIndex == 0) {
			// 第一项
			menuDialogAllButton_txt.setTextColor(mContext.getResources().getColor(R.color.text_normal_blue));
			menuDialogSingleButton_txt.setTextColor(mContext.getResources().getColor(R.color.text_normal_black));
			menuDialogAllButton_icon.setVisibility(View.VISIBLE);
			menuDialogSingleButton_icon.setVisibility(View.GONE);
		} else if (defaultIndex == 1) {
			// 第二项
			menuDialogAllButton_txt.setTextColor(mContext.getResources().getColor(R.color.text_normal_black));
			menuDialogSingleButton_txt.setTextColor(mContext.getResources().getColor(R.color.text_normal_blue));
			menuDialogAllButton_icon.setVisibility(View.GONE);
			menuDialogSingleButton_icon.setVisibility(View.VISIBLE);
		}
	...
	public MenuPopDialog(Context context) {
		...
		menuDialogAllButton = (LinearLayout) view.findViewById(R.id.menuDialogAllButton);
		menuDialogSingleButton = (LinearLayout) view.findViewById(R.id.menuDialogSingleButton);
		menuDialogAllButton_icon = (ImageView) view.findViewById(R.id.menuDialogAllButton_icon);
		menuDialogSingleButton_icon = (ImageView) view.findViewById(R.id.menuDialogSingleButton_icon);
		menuDialogAllButton_txt = (TextView) view.findViewById(R.id.menuDialogAllButton_txt);
		menuDialogSingleButton_txt = (TextView) view.findViewById(R.id.menuDialogSingleButton_txt);
