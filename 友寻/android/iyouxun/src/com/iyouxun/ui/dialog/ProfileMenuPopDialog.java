...
public class ProfileMenuPopDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button_select_blacklist = (Button) findViewById(R.id.button_select_blacklist);
		...
		button_select_blacklist.setOnClickListener(listener);
	...
	private final J_OnViewClickListener listener = new J_OnViewClickListener() {
		...
		public void onViewClick(View v) {
			...
			case R.id.button_select_report:
				...
				dismiss();
				break;
			case R.id.button_select_blacklist:
				// 拉黑
