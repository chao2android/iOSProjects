...
public class SettingMainActivity extends CommTitleActivity {
	...
	private Button settingAboutUs;// 关于我们
	private Button settingMyQRCode;// 我的二维码
	private Button settingUpdateButton;// 检查更新
	...
	protected void initViews() {
		...
		settingAboutUs = (Button) findViewById(R.id.settingAboutUs);
		settingMyQRCode = (Button) findViewById(R.id.settingMyQRCode);
		...
		settingAboutUs.setOnClickListener(listener);
		settingMyQRCode.setOnClickListener(listener);
	...
	private final OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.settingUpdateButton:
				...
				break;
			case R.id.settingMyQRCode:
				// 我的二维码
				Intent qrIntent = new Intent(mContext, SettingMyQRCodeActivity.class);
			...
			case R.id.settingBlackButton:
				...
				break;
			case R.id.settingAboutUs:
				// 关于我们
				Intent aboutIntent = new Intent(mContext, SettingAboutUsActivity.class);
