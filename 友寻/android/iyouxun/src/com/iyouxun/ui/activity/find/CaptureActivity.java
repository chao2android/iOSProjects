...
import com.iyouxun.ui.activity.setting.SettingMyQRCodeActivity;
...
public class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
	...
	private TextView myQrCode;// 我的二维码按钮
	...
	protected void onCreate(Bundle arg0) {
		...
		myQrCode = (TextView) findViewById(R.id.capture_my_qr_code);
		...
		myQrCode.setOnClickListener(listener);
	}
	...
	private final OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.headerLeftButton:// 左侧按钮
				finish();
				break;
			case R.id.capture_my_qr_code:// 我的二维码按钮
				Intent intent = new Intent(mContext, SettingMyQRCodeActivity.class);
