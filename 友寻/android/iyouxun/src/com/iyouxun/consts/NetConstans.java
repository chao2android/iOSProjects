...
public class NetConstans {
	...
	/** 获取推荐标签 */
	public static final String ALTERNATIVE_TAG_LIST_URL = SERVER_URL + "cmiajax/?mod=tags&func=alternative_tag_list&";
	/**
	 * @Fields IS_EXIST_PHOTO_URL : 生活照是否存在
	 */
	public static final String IS_EXIST_PHOTO_URL = SERVER_URL + "cmiajax/?mod=photo&func=is_exist_photo&";
	/** 赞照片 */
	public static final String PRAISE_PHOTO_URL = SERVER_URL + "cmiajax/?mod=photo&func=praisePhoto&";
	/** 取消赞照片 */
	public static final String PRAISE_PHOTO_CANCLE_URL = SERVER_URL + "cmiajax/?mod=photo&func=praisePhotoCancle&";
	/** 照片被赞人员列表 */
	public static final String GET_PHOTO_PRAISE_LIST_URL = SERVER_URL + "cmiajax/?mod=photo&func=getPhotoPraiseList&";
}
