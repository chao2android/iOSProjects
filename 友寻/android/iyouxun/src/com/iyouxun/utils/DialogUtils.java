...
public class DialogUtils {
	 ...
	 * @throws
	 */
	public static void showStangerWarmDialog(Activity mActivity, int sex, boolean isOutSideClose, final OnSelectCallBack callBack) {
		final Dialog dialog = new Dialog(mActivity, R.style.dialog);
		View v = View.inflate(mActivity, R.layout.dialog_stranger_warm_layout, null);
