...
public class ProfileUtils {
	 ...
	 * @throws
	 */
	public static String getAgeStyle(String birth) {
		String ageStyle = "00后";

		if (!Util.isBlankString(birth)) {
			int year = 0;
			if (birth.indexOf("-") > 0) {
				String[] birthAry = birth.split("-");
				year = Util.getInteger(birthAry[0]);
			} else {
				year = Util.getInteger(birth);
			}
			if (year < 1910) {
				ageStyle = "";
