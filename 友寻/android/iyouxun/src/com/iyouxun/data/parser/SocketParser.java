...
import com.iyouxun.net.socket.protocol.PraisePhotoProtocol;
...
public class SocketParser {
	...
	// 照片点赞
	public static final int CMD_SEND_NEW_LIKE_PICTURE_MSG = 320;
	// 发送动态信息
	...
	private void init() {
		...
		protocols.put(CMD_SEND_NEW_LIKE_PICTURE_MSG, PraisePhotoProtocol.class);
	}
