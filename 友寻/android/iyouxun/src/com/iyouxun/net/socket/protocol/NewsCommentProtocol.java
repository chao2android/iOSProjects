 ...
 * 
 * --：动态被赞 <br />
 * {"nick":"孙悟空","from":1001850,"fid":29050,"cmd":311,"timer":1428658968,
 * "pushtype":"text","description":"收到一条动态被赞消息","msgcount":17}
 * 
 * --：转播你的动态<br />
 ...
 * 
 */
public class NewsCommentProtocol extends AbsPushProtocol {
	...
	public SocketProtocol getResponseObj(JSONObject json) throws JSONException {
		...
		bean.replay = json.optString("replay");
