...
#define kBlackListCellLeftPadding 15.0f
#define KBlackListCellTopPadding 10.0f

@implementation JYBlackListCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        //头像
        avatar = [[UIImageView alloc] initWithFrame:CGRectMake(15, 6, 30, 30)];
        [avatar setTag:101];
        ...
        singleView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 6, 12, 12)];
        ...
        //昵称
        nickLab = [[UILabel alloc] initWithFrame:CGRectMake(avatar.right + 10, 0, 100, 24)];
...
- (void)layoutSubviewsWithModel:(JYCreatGroupFriendModel *)model{
    ...
    [nickLab setFrame:CGRectMake(avatar.right + 10, 0, size.width, 24)];
    [nickLab setText:model.nick];
    
    [sexImageView setFrame:CGRectMake(nickLab.right, (nickLab.height - 12)/2, 12, 12)];
