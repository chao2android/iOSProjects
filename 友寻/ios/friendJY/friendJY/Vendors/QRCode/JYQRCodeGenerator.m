...
@implementation JYQRCodeGenerator
...
+ (UIImage *)qrImageForString:(NSString *)string imageSize:(CGFloat)size {
    ...
    CGContextRef ctx = CGBitmapContextCreate(0, size, size, 8, size * 4, colorSpace, kCGImageAlphaPremultipliedFirst);
    ...
    [JYQRCodeGenerator drawQRCode:code context:ctx size:size];
...
+ (UIImage *) twoDimensionCodeImage:(UIImage *)twoDimensionCode withAvatarImage:(UIImage *)avatarImage{
    ...
    CGSize size2 =CGSizeMake(1.0 / 7.5 * size.width, 1.0 / 7.5 * size.height);
...
+ (UIImage *) avatarImage:(UIImage *)avatarImage{
    ...
    UIImage * avatarBackgroudImage = [UIImage imageNamed:@"you_xun_icon"];
